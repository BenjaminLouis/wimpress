...
app_server <- function(input, output, session) {
  ...
  #   sass::sass(input = sass::sass_import(normalizePath(file.path(system.file("www", package = "wimpress"), "template_style.scss"))),
  ...
  #              style_css = normalizePath(file.path(system.file("www", package = "wimpress"), "style.css")))
  # }, ignoreNULL = FALSE)
